...
app = FastAPI(
    title="Local-LM-UI",
    description="Local-LM-UI is a local AI chat web application with authentication, chat history, admin tools, responsive UI and SEO basics.",
    version="1.0.0",
)
...
def health_check():
    ...
    return {"status": "ok", "service": "Local-LM-UI"}
